...
page(_($help_context = "Pay History"), false, false, "", $js);
...
//print_r($sal_list);
//$errors = array_filter($sal_list);

print_r($sal_list);
start_table(TABLESTYLE, "width=90%");
    $th = array(_("Month"), _("Gross Pay"),_("Basic"),_("D A"),_("HRA"),_("Conveyance Allowance"),_("Edu & Other Allowance"),_("LOP Amount"),_("PF "),// _("Staff Loan"),// _("Adv. Salary"),_("TDS"),
